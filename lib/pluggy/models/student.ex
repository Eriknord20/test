defmodule Pluggy.Student do
  ...
  def all do
    Postgrex.query!(DB, "SELECT id, username, first_name, last_name, auth FROM students", [],
  ...
  def update(id, params) do
    ...
    Postgrex.query!(
      DB,
      "UPDATE students SET username = $1, first_name = $2, last_name = $3 WHERE id = $4",
  ...
  def to_struct_list(rows) do
    for [id, username, first_name, last_name, auth] <- rows,
        do: %Student{
          id: id,
          username: username,
